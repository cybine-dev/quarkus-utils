package de.cybine.quarkus.util.action.deployment.service.action;
...
import static de.cybine.quarkus.util.action.deployment.data.action.process.ActionProcessEntity_.*;
